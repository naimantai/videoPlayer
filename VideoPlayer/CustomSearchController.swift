...
class CustomSearchController: UISearchController,UISearchBarDelegate {
    ...
    func configureSearchBar(frame: CGRect, font: UIFont, textColor: UIColor, barColor: UIColor, bgColor: UIColor) {
        ...
        if let seearchBar = customSearchBar {
            seearchBar.barTintColor = barColor
            seearchBar.tintColor = textColor
            seearchBar.backgroundColor = bgColor
            seearchBar.showsBookmarkButton = false
            seearchBar.showsCancelButton = false
            
            seearchBar.delegate = self
        }
