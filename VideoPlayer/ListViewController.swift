...
//        self.listTableView?.reloadData()
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let parentTableView = self.parentViewController as? TableViewController {
            parentTableView.selectedListString = selectedListString
            print("didSet Searchbar String")
        }
        print("detect tap")
    }
